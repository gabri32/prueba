...
import myVideo from './assets/2.mp4';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.container3_1}>
        ...
        <details>
        <summary>25% DEX (Liquidity Pool): &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div className={styles.cantidad}><span>5.250.000 tokens <br />
          </span></div> </summary>
        
        </details>
        <details>
        <summary>5% Promoción y Marketing: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div className={styles.cantidad}><span>1.050.000 tokens <br />
        
          </span></div> </summary>
       
        </details>
        <details>
        <summary>10% Staking: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div className={styles.cantidad}><span>2.100.000 tokens <br />

          </span></div> </summary>
        
        </details>
        <details>
        <summary>15% Equipo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div className={styles.cantidad}><span>3.150000 tokens <br />
        
          </span></div> </summary>
          
        </details>
        <details>
        <summary>30% Distribución general &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div className={styles.cantidad}><span>6.300.000 tokens <br />
      ...
      <section className={styles.faq}>
        ...
        <details>
          ...
          Traishunt es una criptomoneda que busca revolucionar el mundo DeFi (finanzas
...
inversionistas.
        ...
        <details>
          ...
          Traishunt tiene un suministro fijo de 21,000,000 de monedas. No habrá emisión
          adicional después de alcanzar este límite, lo que asegura una oferta controlada.
        </details>
        <details>
          <summary>¿Cómo funciona el sistema de metas y ciclos de Traishunt?
          </summary>
          El sistema de Traishunt está dividido en ciclos, cada uno con metas de recaudación
...
inversionistas.
        ...
        <details>
          ...
          Cuando se alcanza una meta, los inversionistas pueden vender un porcentaje de
